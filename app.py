...
def get_geolocation_route():
    if request.method == 'POST':
        ...
        user_ip_address = '103.57.250.213'
        ...
        print("Phone Number {:>2} {}".format(":", request.form.get('customerId')))
        print("IP address {:>4} {}".format(":", user_ip_address))
        print("Country {:>7} {}".format(":", geolocation_data.get('country')))
        print("Region {:>8} {}".format(":", geolocation_data.get('region')))
        print("City {:>10} {}".format(":", geolocation_data.get('city')))
        print("Time Zone {:>5} {}".format(":", geolocation_data.get('timezone')))
        print("latitude {:>6} {}".format(":", latitude))
        print("longitude {:>5} {}".format(":", longitude))
        print("Google Maps {:>3} {}".format(":", "https://www.google.com/maps/place/"+str(latitude)+"+"+str(longitude)))
        print('')
